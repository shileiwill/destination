...
we add a padding area of 0 to enable the case where the large area is the rectangle without a smaller area on the left to subtract; 
that is, the rectangle's left column is column 0.
    */
}
